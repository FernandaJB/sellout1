...
public interface VentaRepository extends JpaRepository<Venta, Long> {
   ...
   List<Producto> obtenerProductoPorCodBarra(@Param("codBarra") String codBarra);  // Cambiado a List<Producto>
   ...
   List<MantenimientoProducto> obtenerMantenimientoProducto(@Param("codBarra") String codBarra);  // Cambiado a List<MantenimientoProducto>
   ...
   List<MantenimientoProducto> findMantenimientoProductoByCodBarra(@Param("codBarra") String codBarra);  // Cambiado a List<MantenimientoProducto>

   // Nueva consulta que valida y limpia el codBarra antes de la consulta
   default List<Producto> obtenerProductoPorCodBarraLimpio(@Param("codBarra") String codBarra) {
       ...
       // Llamar al método existente para obtener los productos usando el código limpio
       return obtenerProductoPorCodBarra(codBarra);  // Ahora devuelve una lista de productos
   }
}
